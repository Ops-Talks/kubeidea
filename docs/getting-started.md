...
!!! tip "Cross-platform builds"
    ...
    To generate binaries for all supported platforms, the project uses a
    ...
    runners, plus a Fedora container build, and attaches the resulting
    artifacts to each GitHub Release.
